    ...
    return (
      <div id="calculator-container">
        ...
        <div id="calculator-mask" className="remove-highlight">
          ...
          <div className="btn clear"  onClick={ () => { } }></div>
          ...
          <div className="btn equal"    onClick={ () => {  } }></div>
          <div className="btn multiply" onClick={ () => { this.setDisplay('*'); } }></div>
          <div className="btn divide"   onClick={ () => { this.setDisplay('/'); } }></div>
          <div className="btn subtract" onClick={ () => { this.setDisplay('-'); } }></div>
          <div className="btn add"      onClick={ () => { this.setDisplay('+'); } }></div>
        </div>
      </div>
    )
  }
